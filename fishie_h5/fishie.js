...
function setDebugInfo(){
  ...
  var ele = document.getElementById("frameRate");
  ele.innerText = fps.toFixed(0);

  ele = document.getElementById("fishNum");
  ele.value = startFish;

  ele = document.getElementById("fishSpeed");
  ele.value = velocity;
}
...
function init() {
	...
	var windowSize = wxhelper.GetWindowSizeInPx();
